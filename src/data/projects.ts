...
const projects: Project[] = [{
    ...
    abbreviation: 'avg',
    slug: 'adventure-game',
    git: 'https://github.com/harshjayprakash/adventure-game',
    available: false
}, {
    ...
    git: 'https://github.com/harshjayprakash/noughts-and-crosses',
    available: false
}, {
    ...
    git: 'https://github.com/harshjayprakash/trigonometric-helper',
    available: false
}, {
